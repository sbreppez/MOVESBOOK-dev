            ...
            <div ref={menuRef} style={{ flexShrink:0 }}>
              ...
              {menu&&<div onClick={e=>e.stopPropagation()}
                ...
                {!subColor ? <Fragment>
                  ...
                  <button onClick={()=>setSubColor(false)} style={{ width:"100%", padding:"8px 13px", background:C.surfaceAlt, border:"none", cursor:"pointer", display:"flex", alignItems:"center", gap:6, color:C.textSec, fontSize:11, fontFamily:"inherit", borderBottom:`1px solid ${C.border}` }}>← {t("back")}</button>

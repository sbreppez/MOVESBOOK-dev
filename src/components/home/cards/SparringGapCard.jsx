...
export const SparringGapCard = ({ sparring }) => {
  ...
  const isStale = gap >= 14;
  const color = isStale ? C.yellow : C.green;
  ...
  return (
    <div style={{
      ...
      <div style={{ display:"flex", alignItems:"baseline", gap:6 }}>
        <span style={{ fontSize:22, fontWeight:900, fontFamily:FONT_DISPLAY, color }}>{gap}</span>

...
export const CARD_BASE  = () => ({ borderRadius:8, background:C.surface, overflow:"hidden", boxShadow:"0 4px 15px rgba(0,0,0,0.12)", minHeight:168, minWidth:0, display:"flex", flexDirection:"column", position:"relative" });

...
export const BulkModal = ({ onClose, onImport, category }) => {
  const t = useT();
  ...
  return (
    <Modal title={t("bulkImport")} onClose={onClose} wide>
      {step===1 ? <Fragment>
        ...
        <Sel label={t("importToCategory")} value={cat} onChange={setCat} options={CATS}/>
